    ...
    return (
            <section>
                ...
                <div className="minbaggrund-main">
                    ...
                    <p className="baggrundstekst">Jeg er uddannet fra Kolding Frisørskole med speciale  i opsætning siden 2017.</p>
                    <img className="Kigind-billede" src="/images/KigInd2.jpg" alt="Salonen udefra"></img>
                </div>

                <div className="kigind-main">
                    <h2 className="kigind-overskrift">Kig ind i salonen</h2>
                    <img className="Kigind-billede" src="/images/KigInd3.jpg" alt="Salonen udefra"></img>
                        <br></br>
                    <img className="Kigind-billede" src="/images/KigInd4.jpg" alt="Salonen indenfor"></img>
                        <br></br>
                    <img className="Kigind-billede" src="/images/KigInd5.jpg" alt="Salonen indenfor"></img>
                        <br></br>
                </div>
            </section>
